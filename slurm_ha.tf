...
resource "null_resource" "cluster_backup" { 
  ...
  provisioner "file" {
    content        = templatefile("${path.module}/inventory.tpl", {  
      ...
      billing_mysql_db_admin_password = var.billing ? var.billing_mysql_db_admin_password : "",
      billing_mysql_db_admin_username = var.billing ? var.billing_mysql_db_admin_username : "",
