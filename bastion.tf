...
resource "null_resource" "cluster" { 
  ...
  provisioner "file" {
    content        = templatefile("${path.module}/inventory.tpl", {  
      ...
      create_weka = var.create_weka,
      weka_drive_core_ids = var.weka_drive_core_ids,
      weka_compute_core_ids = var.weka_compute_core_ids,
      weka_frontend_core_ids = var.weka_frontend_core_ids,
