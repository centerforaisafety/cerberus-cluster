...
variable "weka_drive_core_ids" { default = "0,1,64,65"}
variable "weka_compute_core_ids" { default = "2,3,4,5,6,7,66,67,68,69,70,71"}
variable "weka_frontend_core_ids" { default = "8,9,72,73"}
